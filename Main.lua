...
local Window = Libary:MakeWindow({
    Title = "Fire Hub",
    SubTitle = "by:  Developers (Fros230_0,blox_doido_23968)",
    LoadText = "nitro Developers",
    Flags = "Broookhaven"
})
...
InfoTab:AddParagraph({ "Owner / Developer:", "frost230_0,blox_doido_23968" })
InfoTab:AddParagraph({ "Colaborações:", "blox_doido_23968" })
InfoTab:AddParagraph({ "Você está usando:", "Fire  Hub" })
InfoTab:AddParagraph({"This script is open-source, just check our GitHub page!"})
InfoTab:AddParagraph({"Novidades:", "+4 áudios novos na tab Audio All! (adicionado por thenada)"})
...
Tab:AddButton({
    Name = "Shutdown Servidor - The server has shutdown",
    Callback = function()
        for m = 1, 495 do
            local args = {
                [1] = "PickingTools",
...
Tab:AddButton({
    Name = "Shutdown Servidor - Please check your internet connection",
    Callback = function()
        for m = 1, 535 do
            local args = {
                [1] = "PickingTools",
...
Tab:AddButton({
    Name = "Shutdown Servidor - unexpected client behavior",
    Callback = function()
        for m = 1, 635 do
            local args = {
                [1] = "PickingTools",
