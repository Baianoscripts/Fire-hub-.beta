-- Tela de Carregamento Fire Hub Brookhaven - Estilizada
...
local Window = redzlib:MakeWindow({
  Title = "Fire hub | Brookhaven 1.0.0🏡🪐",
  SubTitle = "by frost230_0",
  SaveFolder = "testando | Fire v1"
})
...
local Paragraph = Tab1:AddParagraph({"Criador", "Frost230_0"})

local Paragraph = Tab1:AddParagraph({"Versão", "1.0.0V"})

local Paragraph = Tab1:AddParagraph({"Executor", "KRNL"})
...
local Window = WindUI:CreateWindow({
    ...
    Resizable = true,
    SideBarWidth = 200,
    Background = "8652665149", -- rbxassetid or video 
    ...
    KeySystem = {
        Key = { "Frost230_0", "PainelAdm" },
        Note = "⚒️Painel  Staff⚒️",
        Thumbnail = {
